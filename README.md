...
The easiest way to access the course materials stored on this site is to [install Git](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git).  Then, at the command line do 
    ...
    git clone https://github.com/ketch/AMCS-252-2026.git

That will create a directory on your computer with all the files stored here.  When new files are added online, all you need to do is go to the `AMCS-252-2026` directory on your machine and type
...
packages (NumPy, SciPy, and Matplotlib).  In-class demonstrations and some
homework assignments will be distributed in the form of Jupyter notebooks.

No prior experience with Python is
...
If needed, a Python tutorial will be given in class near the start of the semester.
...
Breakpoints may be adjusted slightly (lower) depending on the difficulty of the exams that year.
